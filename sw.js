const CACHE='raphy-v10-20260920';
const ASSETS=['./','./index.html','./styles.css','./enhancements.css','./app.js','./app-v2a.js','./app-v2b.js','./app-v2c.js','./app-v2d.js','./manifest.json','./icon.svg'];
